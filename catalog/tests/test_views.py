...
class AuthorCreateViewTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        # Give test_user2 permission to add author.
    ...
    def test_logged_in_with_permission_add_author(self):
        ...
        # Check that it lets us login - this is author create page and we have the right permissions.
        self.assertEqual(response.status_code, 200)
    ...
    def test_form_initially_has_date_of_death_as_expected(self):
        login = self.client.login(username='testuser2', password='2HJ1vRV0Z&3iD')
        response = self.client.get(reverse('author-create'))
        self.assertEqual(response.status_code, 200)
